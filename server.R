...
shinyServer(function(input, output, session) {
            ...
            observeEvent(input$analyze, {
                  ...
                  if (length(file_names) > 0) {
                      data_extractor(directory_path, experiment, runner, file_names, time_value)
                      output$message <- renderText("Data Conversion and Extraction complete. \nCheck your specified directory for the output file.")
                      ...
                      output$message <- renderText("Please provide a list of file names separated by comma to begin the analysis.")
                  }
            })
